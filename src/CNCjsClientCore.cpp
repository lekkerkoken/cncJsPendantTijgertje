...
void CNCjsClientCore::debugStateEvent(
    const char* eventName,
    JsonArray array
)
{
...
void CNCjsClientCore::debugSerialportWrite(
    JsonArray array
)
{
#ifdef CNCJS_EVENT_DEBUG
...
void CNCjsClientCore::debugSerialportRead(
    JsonArray array
)
{
#ifdef CNCJS_EVENT_DEBUG
